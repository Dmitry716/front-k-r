...
const pageTitles: Record<string, string> = {
  ...
  '/monuments/single': 'Одиночные памятники',
  '/monuments/double': 'Двойные памятники',
  '/monuments/exclusive': 'Эксклюзивные памятники',
  '/monuments/cheap': 'Недорогие памятники',
  '/monuments/cross': 'Памятники в виде креста',
  '/monuments/heart': 'Памятники в виде сердца',
  '/monuments/composite': 'Составные памятники',
  '/monuments/europe': 'Европейские памятники',
  '/monuments/artistic': 'Художественная резка',
  '/monuments/tree': 'Памятники в виде деревьев',
  '/monuments/complex': 'Мемориальные комплексы',
  '/fences/granite': 'Гранитные ограды',
  '/fences/polymer': 'Ограды с полимерным покрытием',
  '/fences/metal': 'Металлические ограды',
  '/accessories/vases': 'Вазы',
  '/accessories/lamps': 'Лампады',
